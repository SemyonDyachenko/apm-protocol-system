  ...
  return (
    <div>
      ...
      <InformationSection
        ...
        label="ОРАНИЗАТОРАМ"
        underText="Организаторам предоставляется уникальная возможность
      ...
      />
      <InformationSection
        underText="Спортсменам предоставляется возможность участвовать в турнирах любого уровня, создать собственную команду или провести свой турнир."
